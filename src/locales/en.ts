const translations = {
  ...
  camera_permissions_settings: {
    label: "Camera access",
    description:
      "Allow the app to use your device's camera for capturing photos or videos.",
  },
  cancel_order_prompt: {
  ...
  display_settings_helper_text:
    "These display settings are stored locally on your device and will not be synced with your account.",
  ...
  error_400_toast: {
    title: "Bad request",
    description:
      "The server could not process the request due to client error.",
  },
  error_401_toast: {
    title: "Unauthorized",
  ...
  error_409_toast: {
    ...
    description:
      "Request could not be processed because the data already exists",
  },
  error_500_toast: {
    title: "Server error",
  ...
  layout_menu_helper:
    "These layout settings are stored locally on your device and will not be synced with your account.",
  legend: "Legend",
  ...
  location_permissions_settings: {
    ...
    description:
      "Allow the app to access your device's location for location-based services.",
  },
  ...
  logout_disclosure: {
    title: "Logout?",
    description:
      "Make sure there is no process to the server before the logout is confirmed to avoid authentication errors.",
  },
  ...
  maintenance_page:
    "We are currently performing maintenance to provide better service. Sorry for the inconvenience. Please check back later.",
  male: "Male",
  map_type: "Map type",
  ...
  mic_permissions_settings: {
    ...
    description:
      "Allow the app to use your device's microphone for recording audio.",
  },
  ...
  payment_agreement:
    "By making a payment, you agree to the payment terms and conditions.",
  ...
  payment_trust: {
    ...
    description:
      "Payments are securely processed via Midtrans and CoinPayment, ensuring trust and protection.",
  },
  ...
  permissions_settings_helper_text:
    "These app permissions settings are stored locally on your device and will not be synced with your account.",
  ...
  regional_settings_helper_text:
    "These language & region settings are stored locally on your device and will not be synced with your account.",
  religion: "Religion",
  required_form: "Cannot be empty",
  requried_date_time:
    "Please fill in the date and time, as they are one entity.",
  ...
  server_error_page:
    "Our system is currently experiencing an issue. Our team is working to fix it.",
